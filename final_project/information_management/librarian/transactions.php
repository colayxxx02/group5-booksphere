                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!$is_returned): ?>
                                    <button class="btn-edit" onclick="openReturn('<?= $row['transaction_id'] ?>','<?= $row['user_id'] ?>','<?= $row['book_id'] ?>','<?= addslashes($row['title']) ?>','<?= addslashes($row['fullname']) ?>')"><span class="material-symbols-outlined">keyboard_return</span></button>
                                <?php endif; ?>
