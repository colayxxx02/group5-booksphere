...
switch ($type) {
    case 'total':
        ...
        if (empty($all_books)) {
            ...
            $html = '<div style="margin-bottom:10px; color:#888; font-size:13px;">Total: ' . $total_books . ' book' . ($total_books > 1 ? 's' : '') . ' borrowed</div>';
    ...
    case 'month':
        ...
        if (empty($month_books)) {
            ...
            $total_books = count($month_books);
            $html = '<div style="margin-bottom:10px; color:#888; font-size:13px;">Total: ' . $total_books . ' book' . ($total_books > 1 ? 's' : '') . ' this month</div>';
            $html .= '<div class="details-list">';
    ...
    case 'category':
        ...
        if (empty($categories)) {
            ...
            $html = '<div style="margin-bottom:10px; color:#888; font-size:13px;">Reading from ' . $total_categories . ' categor' . ($total_categories > 1 ? 'ies' : 'y') . '</div>';
            $html .= '<div class="details-list">';
    ...
    case 'ontime':
        ...
        if (empty($returns)) {
            ...
            $on_time_count = count(array_filter($returns, function($r) { return $r['status'] == 'On Time'; }));
            $html = '<div style="margin-bottom:10px; color:#888; font-size:13px;">Total: ' . $total_returns . ' return' . ($total_returns > 1 ? 's' : '') . ' (' . $on_time_count . ' on time)</div>';
            $html .= '<div class="details-list">';
