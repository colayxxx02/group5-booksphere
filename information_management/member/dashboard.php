...
<body class="dashboard-page">
            ...
            <div class="reading-stats-section">
                ...
                <div class="stats-grid-full">
                    ...
                    <div class="stat-item" onclick="showReadingDetails('ontime')">
                        ...
                        <div class="stat-info">
                            <div class="stat-value"><?= $on_time_returns ?></div>
                            <div class="stat-label">On-Time Returns</div>
                            <div class="stat-subtext"><?= $total_returns - $on_time_returns ?> late returns</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="readingDetailsModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <div id="readingDetailsContent" class="modal-scrollable-content">
